...
public class VertexGroup
{
    ...
    public static VertexGroup CreateRoundedRectangleAuto(GeometryShape owner, Point2 location, Size2 size, Color color, float radius)
    {
        var group = new VertexGroup(owner);
        var quality = (int)(radius * 0.4f);
